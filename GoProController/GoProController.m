...
goProSetLowLightOn::usage=
	"goProSetLowLightOn[ ] turns LowLight on if FPS is set to 60+."
goProSetLowLightOff::usage=
	"goProSetLowLightOff[ ] turns LowLight off."
...
(*Locate*)
goProLocate[]:=execute[goProMakeCommand["camera","LL","01"]]
goProLocateStop[]:=execute[goProMakeCommand["camera","LL","00"]]
...
goProSetPhotoRes[param_String]:=execute[goProMakeCommand["camera","PR",photoResToCode[[param]]]]
goProGetPossiblePhotoRes[]:=photoResPossible
 
goProPhotoRes12W[]:=goProSetVideoRes[photoResPossible[[3]]]
goProPhotoRes7W[]:=goProSetVideoRes[photoResPossible[[2]]]
goProPhotoRes7M[]:=goProSetVideoRes[photoResPossible[[4]]]
goProPhotoRes5M[]:=goProSetVideoRes[photoResPossible[[1]]]
...
goProSetVideoRes[param_String]:=execute[goProMakeCommand["camera","VV",videoResToCode[[param]]]]
goProGetPossibleVideoRes[]:=videoResPossible


goProVideoResWVGA[]:=goProSetVideoRes[videoResPossible[[1]]]
goProVideoRes720[]:=goProSetVideoRes[videoResPossible[[2]]]
goProVideoRes960[]:=goProSetVideoRes[videoResPossible[[3]]]
goProVideoRes1080[]:=goProSetVideoRes[videoResPossible[[4]]]
goProVideoRes1440[]:=goProSetVideoRes[videoResPossible[[5]]]
goProVideoRes2point7K[]:=goProSetVideoRes[videoResPossible[[6]]]
goProVideoRes4K[]:=goProSetVideoRes[videoResPossible[[7]]]
goProVideoRes2point7K17to9[]:=goProSetVideoRes[videoResPossible[[8]]]
goProVideoRes4K17to9[]:=goProSetVideoRes[videoResPossible[[9]]]
goProVideoRes1080SV[]:=goProSetVideoRes[videoResPossible[[10]]]
goProVideoRes720SV[]:=goProSetVideoRes[videoResPossible[[11]]]
...
goProGetPossibleFPS[res_String]:=fpsPossible[[videoResToCode[[res]]]]
...
goProGetPossibleBurstRate[]:=brPossible
goProSetBurstRate[param_String] := execute[goProMakeCommand["camera","BU",brToCode[[param]]]]
...
goProGetPossibleVideoLoop[]:=loPossible
goProSetVideoLoop[param_String] := execute[goProMakeCommand["camera","LO",loToCode[[ToLowerCase[param] ]]]]
...
csToCode = <|
   ...
   |>;
csPossible={"1", "3","5","10"}
goProGetPossibleContinuousShot[]:=csPossible
goProSetContinuousShot[param_String] := execute[goProMakeCommand["camera","CS",csToCode[[ToLowerCase[param] ]]]]
...
goProGetPossiblePhotoInVideo[]:=pnPossible
goProSetPhotoInVideo[param_String] := execute[goProMakeCommand["camera","PN",pnToCode[[ToLowerCase[param] ]]]]
...
goProGetPossibleVolume[]:=bsPossible
goProSetVolume[param_String] := execute[goProMakeCommand["camera","BS",bsToCode[[ToLowerCase[param] ]]]]
...
ptPossible={"off","on"}
goProGetPossibleProtune[]:=ptPossible
goProSetProtune[param_String] := execute[goProMakeCommand["camera","PT",ptToCode[[ToLowerCase[param] ]]]]
goProSetProtuneOn[]:=goProSetProtune["on"] 
goProSetProtuneOff[]:=goProSetProtune["off"] 
...
goProGetPossibleWhiteBalance[]:=wbPossible
goProSetWhiteBalance[param_String] := execute[goProMakeCommand["camera","WB",wbToCode[[ToLowerCase[param] ]]]]
...
goProSetColorProfile[param_String] := execute[goProMakeCommand["camera","CO",coToCode[[ToLowerCase[param] ]]]]
...
goProGetPossibleISO[]:=gaPossible
goProSetISO[param_String] := execute[goProMakeCommand["camera","GA",gaToCode[[ToLowerCase[param] ]]]]
...
goProGetPossibleSharpness[]:=spPossible
goProSetSharpness[param_String] := execute[goProMakeCommand["camera","SP",spToCode[[ToLowerCase[param] ]]]]
...
goProSetExposure[param_String] := execute[goProMakeCommand["camera","EV",evToCode[[ToLowerCase[param] ]]]]
...
|>
lwPossible={"off","on"}
goProGetPossibleLowLight[]:=lwPossible
goProSetLowLight[param_String]:= execute[goProMakeCommand["camera","LW",lwToCode[[ToLowerCase[param] ]]]]
goProSetLowLightOn[]:=goProSetLowLight["on"]
goProSetLowLightOff[]:=goProSetLowLight["off"]
...
|>
lbPossible={"off","2","4"}
goProGetPossibleLed[]:=lbPossible
goProSetLed[param_String]:= If[ToLowerCase[param]=="off",
...
|>
exPossible={"off","on"}
goProGetPossibleSpotMeter[]:=exPossible
goProSetSpotMeter[param_String]:= execute[goProMakeCommand["camera","EX",exToCode[[ToLowerCase[param] ]]]]
goProSetSpotMeterOn[]:=goProSetSpotMeter["on"]
goProSetSpotMeterOff[]:=goProSetSpotMeter["off"]
...
goProGetPossibleAutoPowerOff[]:=aoPossible
goProSetAutoPowerOff[param_String] := execute[goProMakeCommand["camera","AO",aoToCode[[ToLowerCase[param] ]]]]
...
|>
vmPossible={"NTSC","PAL"}
goProGetPossibleVideoMode[]:=vmPossible
goProSetVideoMode[param_String]:= execute[goProMakeCommand["camera","VM",vmToCode[[ToLowerCase[param] ]]]]
	


(*time Setting*)
toHex[param_String] := (final = "";
  td = param;
...
toFancyTime[param_List]:="20"<>ToString[param[[1]]]<>"-"<>ToString[param[[2]]]<>"-"<>ToString[param[[3]]]<>" "<>ToString[param[[4]]]<>":"<>ToString[param[[5]]]<>":"<>ToString[param[[6]]]

(*<>" "<>ToString[Drop[param,1][[4]]]<>":"<>ToString[Drop[param,1][[5]]]<>":"<>ToString[Drop[param,1][[6]]]*)

goProSetTime[param_String]:= If[StringLength[param] != 12 || !NumberQ[ToExpression[param]],
	Print[StringLength[param]];Print["Wrong lenght of input string or it doesn't contains only numbers."],
	execute[goProMakeCommand["camera", "TM", toHex[param]]]
	]
goProGetTime[]:=toFancyTime[Drop[goProGetStatus["camera", "tm"],1]]
...
goProGetSettingReport[]:= (Print["Time of camera: "<>goProGetTime[]];
...
settingsToList[]:={codeToMode[[ "0"<>ToString[goProGetStatus["camera", "cm"][[2]] ] ]],
...
goProSaveSettings[file_String]:=Export[file,settingsToList[]]
...
Options[goProSetVideo] = {videoResolution -> "1080p", fps -> "30", fov -> "wide",videoMode->"NTSC"};
...
Options[goProSet]={videoResolution -> "1080p", fps -> "30", fov -> "wide", videoMode->"NTSC",
	photoResolution->"12W",loopVideo->"off",burstRate->"30/1",timeLapse->"1",
	continuousShot->"1",photoInVideo->"off",volume->"off", led->"4", lowLight->"off",spotMeter->"off", autoPowerOff->"off",
	protune->"off",whiteBalance->"auto",colorProfile->"GoPro",iso->goProGetPossibleISO[][[1]],
	sharpness->goProGetPossibleSharpness[][[1]],exposure->goProGetPossibleExposure[][[1]]}

goProSet[OptionsPattern[]] := (goProSetVideo[Flatten[{videoResolution->OptionValue[videoResolution],fps-> OptionValue[fps], fov->OptionValue[fov],videoMode->OptionValue[videoMode]}]];
  goProSetPhotoRes[OptionValue[photoResolution]];
  goProSetVideoLoop[OptionValue[loopVideo]];
  goProSetBurstRate[OptionValue[burstRate]];
  goProSetTimeLapse[OptionValue[timeLapse]];
  goProSetContinuousShot[OptionValue[continuousShot]];
  goProSetPhotoInVideo[OptionValue[photoInVideo]];
  goProSetVolume[OptionValue[volume]];
  goProSetLed[OptionValue[led]];
  goProSetLowLight[OptionValue[lowLight]];
  goProSetSpotMeter[OptionValue[spotMeter]];
  goProSetAutoPowerOff[OptionValue[autoPowerOff]];
  
  goProSetProtune[OptionValue[protune]];
  goProSetWhiteBalance[OptionValue[whiteBalance]];
  goProSetColorProfile[OptionValue[colorProfile]];
  goProSetISO[OptionValue[iso]];
  goProSetSharpness[OptionValue[sharpness]];
  goProSetExposure[OptionValue[exposure]]
  )
